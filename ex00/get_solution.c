...
/*   Updated: 2021/07/10 16:38:25 by pleveque         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	*get_solution_branch(int *solution, int *border_value, int size, int *dest)
{
	int	actual_case;
	int	number_of_case;
	int	*possible_case;
	...
	number_of_case = size * size;
	actual_case = get_array_size(new_solution);
